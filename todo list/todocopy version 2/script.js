...
function removeTasksTitle(e) {
	...
	if(prompt('Are you sure?')) {
		...
		if(document.body.querySelector('tasks')) {
			addNewTodo();
		} else if((parentDiv === target) || (parentDiv === previous)) {
...
function updateSidebar(e) {
	const targetSidebarTask = document.body.querySelector(`.sidebar-${targetUniqueKey}`);
